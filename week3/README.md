...
## Brief description
The week3 directory is organized with code, data, results, sandbox, README.md, and .gitignore. There are a few data files downloaded from the [TheMulQuaBio repository](https://github.com/mhasoba/TheMulQuaBio) as required in the data directory. 
...
And the code directory also holds the LaTeX written work and compiled pdf of the written report for the [Is Florida getting warmer Exercise](https://mhasoba.github.io/TheMulQuaBio/notebooks/07-R.html#id2). 
...
## Dependencies
For the week3 section, there are some useful R packages such as tidyverse needed to be installed. Requiring tidyverse will load the core tidyverse packages: ggplot2, for data visualisation; dplyr, for data manipulation; tidyr, for data tidying. 
...
The week3 part includes code, data, results, and sandbox. There are some R scripts in the code directory.
...
And the code directory also contains a LaTeX file called Florida_warming.tex and a pdf document about the results and interpretation written in LaTeX for the Florida_warming.R script.
